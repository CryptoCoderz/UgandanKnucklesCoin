...
#if defined(NDEBUG)
# error "UgandanKnucklesCoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "UgandanKnucklesCoin Signed Message:\n";
...
unsigned int GetNextTargetRequired(const CBlockIndex* pindexLast, bool fProofOfStake)
{
    ...
    //LogPrintf("UgandanKnucklesCoin "we know de wey" retargetted using: DGW-v3 difficulty algo \n");
...
{
    RenameThread("UgandanKnucklesCoin-loadblk");
